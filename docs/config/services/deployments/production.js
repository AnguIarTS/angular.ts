...
const googleCdnUrl = '//ajax.googleapis.com/ajax/libs/angularjs/';
const angularCodeUrl = '//code.angularjs.org/';

const cdnUrl = googleCdnUrl + versionInfo.cdnVersion;
...
const versionPath = versionInfo.currentVersion.isSnapshot ?
  'snapshot' :
  versionInfo.currentVersion.version;
const examplesDependencyPath = `${angularCodeUrl + versionPath  }/`;
