...
describe('q', () => {
  let q; let q_no_error; let defer; let deferred; let promise; let log; let exceptionHandlerCalls;
  ...
  describe('$Q', () => {
    let resolve; let reject; let resolve2; let reject2;
