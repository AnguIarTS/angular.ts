...
describe('form', () => {
  let doc; let control; let scope; let $compile; let changeInputValue;
  ...
  beforeEach(inject(($injector, $sniffer) => {
  ...
  describe('$pending', () => {
    ...
    it('should set valid and invalid to undefined when a validation error state is set as pending', inject(($q, $rootScope) => {
      let defer; const form = doc.data('$formController');
