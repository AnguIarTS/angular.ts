...
describe('ngSrc', () => {
  ...
  describe('img[ng-src]', () => {
    it('should not result empty string in img src', inject(($rootScope, $compile) => {
      $rootScope.image = {};
    ...
    it('should sanitize interpolated url', inject(($rootScope, $compile) => {
    ...
    it('should sanitize non-interpolated url', inject(($rootScope, $compile) => {
      element = $compile('<img ng-src="javascript:alert(1);">')($rootScope);
      $rootScope.$digest();
      expect(element.attr('src')).toBe('unsafe:javascript:alert(1);');
    }));

    it('should interpolate the expression and bind to src with raw same-domain value', inject(($compile, $rootScope) => {
    ...
    it('should interpolate a multi-part expression for img src attribute (which requires the MEDIA_URL context)', inject(($compile, $rootScope) => {
    ...
    if (msie) {
      it('should update the element property as well as the attribute', inject(($compile, $rootScope, $sce) => {
    ...
    it('should work with `src` attribute on the same element', inject(($rootScope, $compile) => {
  ...
  describe('iframe[ng-src]', () => {
    it('should pass through src attributes for the same domain', inject(($compile, $rootScope) => {
    ...
    it('should error on src attributes for a different domain', inject(($compile, $rootScope) => {
      element = $compile('<iframe ng-src="{{testUrl}}"></iframe>')($rootScope);
    ...
    it('should error on JS src attributes', inject(($compile, $rootScope) => {
      element = $compile('<iframe ng-src="{{testUrl}}"></iframe>')($rootScope);
    ...
    it('should error on non-resource_url src attributes', inject(($compile, $rootScope, $sce) => {
      element = $compile('<iframe ng-src="{{testUrl}}"></iframe>')($rootScope);
    ...
    it('should interpolate the expression and bind to src with a trusted value', inject(($compile, $rootScope, $sce) => {
    ...
    it('should NOT interpolate a multi-part expression in a `src` attribute that requires a non-MEDIA_URL context', inject(($compile, $rootScope) => {
      expect(() => {
    ...
    it('should NOT interpolate a wrongly typed expression', inject(($compile, $rootScope, $sce) => {
      expect(() => {
        element = $compile('<iframe ng-src="{{id}}"></iframe>')($rootScope);
        $rootScope.$apply(() => {
